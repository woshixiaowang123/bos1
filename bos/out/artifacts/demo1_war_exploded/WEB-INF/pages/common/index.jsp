        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
                ...
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" type="Password" class="txt01 easyui-validatebox" data-options="required:true,validType:'length[3,11]'" /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input id="txtRePass" type="Password" class="txt01 easyui-validatebox" required="required"
								   validType="equals['#txtNewPass']"/></td>
                    </tr>
                </table>
				</form>
            </div>
	...
	<script type="text/javascript">
		$(function () {
            $("#btnEp").click(function(){
               ...
               if(v){
                //还要验证是否相等,如果相等则传到action层修改密码,如果不相等,则提示
                   var v1=$("#txtNewPass").val();
                   var v2=$("#txtRePass").val();
                   if(v1==v2){
                       //说明两次密码一致,可以发出异步请求
                       var url="${pageContext.request.contextPath}/userAction_changePassword.action";
                       ...
                       $.messager.alert('提示信息','您两次输入的密码不一致!','warning')
                   }
               }
            });
        })
