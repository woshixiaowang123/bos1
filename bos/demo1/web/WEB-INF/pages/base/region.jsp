...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/regionAction_findPage.action",
			idField : 'id',
			columns : columns,
        ...
        $("#button-import").upload({
            action:'${pageContext.request.contextPath}/regionAction_upFile.action',//form表单的提交地址
            ...
            onComplete: function (data, self, element) {//当服务端写回数据后此方法执行
                if(data == '1'){
                    ...
                    //导入失败
                    $.messager.alert("提示信息","区域数据导入失败！","waring");
                }
            }
        });
